...
Having completed the prosthetic control part of the experiment, the next step was to determine the subject's sensory thresholds, which would be used to convey feedback information. The electrode array was fixated on the non-dominant arm distal to the elbow joint \frac{1}{3} towards the wrist from the elbow joint. The center electrode pads were placed most central on the anterior side of arm, when using a pronated arm as reference. See illustration in \figref{fig:meth:elec_place}.
