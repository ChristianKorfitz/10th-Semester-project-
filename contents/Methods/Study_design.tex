...
\begin{table}[H]
	...
	\begin{tabular}{llll} \hline
		...
		&                & Female          & Male           \\ \hline
		\begin{tabular}[c]{@{}l@{}}\textbf{Total}\\ (n = 14)\end{tabular}   & \multicolumn{1}{c}{26.1(2.4)}    & 2       & 12      \\
